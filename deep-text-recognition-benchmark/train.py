...
def commandline_arg(bytestring):
    # unicode_string =  os.fsdecode(bytestring)
    unicode_string =  os.fsdecode(bytestring)
...
def train(opt):
    ...
    while(True):
        ...
        if (iteration + 1) == opt.num_iter:
            ...
            sys.exit()
        # if (iteration + 1) % 10 == 0:   
            # print(f"Iteration {iteration + 1} / {opt.num_iter}")
        iteration += 1
...
if __name__ == '__main__':
    ...
    parser.add_argument('--character', type=commandline_arg,
                        # default=' ا ب ت ث ح خ ج د ذ ر ز س ش ص ض ط ظ ع غ ف ق ك ل م ن ه و ي ء ~ أ', help='character label')
                        default=' ابتثحخجدذرزسشصضطظعغفقكلمنهويء~أ', help='character label')
